...
console.log('4. Removed last item which was added mistakenly:', supplyChanges.pop());

// 5. A delivery of 25 more parts arrived. Add the value 25 to the end of the array
supplyChanges.push(25)
console.log('5. Adding new delicery of 25 to supplyChanges.', supplyChanges);
...
console.log(`Leftover parts: ${stash}`)